...
void MainWindow::printSpikePlots() {
    ...
    QVector<double> yValues = DataGenerator::generateHarmonicFunc(sizeN, discreteStep, 5, 1);
    QVector<double> yValues2 = DataGenerator::generateHarmonicFunc(sizeN, discreteStep, 15, 2);
    ...
    QVector<double> yValues5 = DataProcessor::addShift(yValues4, -2.5);
    ...
    GraphPlotter::plotFunction(ui->widget_2, xValues, yValues7);
}
